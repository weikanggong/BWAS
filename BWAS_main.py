...
def cli_parser():
    ...
    parser.add_argument('-target_file', help='The absolute directory of the variable of interests file (nsub * 1 numpy matrix saved in .npy format)')
    parser.add_argument('-cov_file', help='The absolute directory of the covariates file (nsub * p numpy matrix saved in .npy format)')
